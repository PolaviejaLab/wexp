...
{
    /**
     * @Route("/{_locale}/admin/screens", name="admin_screens", requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/admin/screens/by-experiment/{$experiment}", name="admin_screens_by_experiment", requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/admin/screen/create/{experiment}", name="admin_screen_create", defaults={"experiment" = null}, requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/admin/screen/{screen_id}/edit", name="admin_screen_edit", requirements={"_locale" = "%app.locales%"})
     */
