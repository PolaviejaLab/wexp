...
{
    /**
     * @Route("/{_locale}/admin/sessions", name="admin_sessions", requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/admin/experiment/{experiment}/sessions", name="admin_sessions_by_experiment", requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/admin/experiment/{experiment}/dataset", name="admin_sessions_export", requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/admin/session/{session}/details", name="admin_session_details", requirements={"_locale" = "%app.locales%"})
     */
