...
{
    /**
     * @Route("/{_locale}/screen/get/{experiment_id}/{screen_name}", requirements={"_locale" = "%app.locales%"})
     */
    ...
    /**
     * @Route("/{_locale}/screen/compile/{experiment_id}/{screen_name}", requirements={"_locale" = "%app.locales%"})
     */
